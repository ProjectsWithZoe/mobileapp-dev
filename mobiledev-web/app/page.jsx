...
import { getStripeLink } from '../src/lib/stripe'
...
const PromptGenerator = lazy(() => import('../src/components/ComplexGenerator'))
const AuthModal       = lazy(() => import('../src/components/AuthModal'))
const CookieBanner    = lazy(() => import('../src/components/CookieBanner'))
...
export default function Home() {
  ...
  const [isDemoMode, setIsDemoMode]       = useState(process.env.NODE_ENV === 'development')
